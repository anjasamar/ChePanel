...
class LetsEncryptSecureDomain
{
    ...
    public function handle(): void
    {
        ...
        shell_exec('chmod +x /usr/local/che/web/Modules/LetsEncrypt/shell/hooks/pre/http-authenticator.sh');
        shell_exec('chmod +x /usr/local/che/web/Modules/LetsEncrypt/shell/hooks/post/http-cleanup.sh');
        shell_exec('chmod +x /usr/local/che/web/Modules/LetsEncrypt/shell/acme.sh');
        ...
        if (
            !file_exists($sslCertificateFilePath)
            ...
            $exec = shell_exec("bash /usr/local/che/web/Modules/LetsEncrypt/shell/acme.sh  --register-account  -m " . $generalSettings['master_email'] . " --server zerossl");
