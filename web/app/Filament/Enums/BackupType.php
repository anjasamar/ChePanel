...
enum BackupType: string implements HasLabel, HasDescriptions, HasIcons
{
    ...
    {
        return match ($this) {
            self::FULL_BACKUP => 'A full backup of the server. Includes che system full configuration and hosting subscriptions.',
            self::SYSTEM_BACKUP => 'A backup of the che system full configuration',
