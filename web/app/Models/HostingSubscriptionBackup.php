...
class HostingSubscriptionBackup extends Model
{
    ...
    {/*
        $cronJobCommand = 'che-php /usr/local/che/web/artisan che:create-daily-full-hosting-subscriptions-backup';
    ...
    public function startBackup()
    {
        ...
        $backupStorageRootPath = '/var/lib/che/backups/hosting_subscriptions';
