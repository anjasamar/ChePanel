...
class GitRepository extends Model
{
    ...
    public function pull()
    {
        ...
        $gitExecutorContent = view('actions.git.git-executor', [
            ...
            'afterCommand' => 'che-php /usr/local/che/web/artisan git-repository:mark-as-pulled ' . $this->id,
        ])->render();
    ...
    public function clone()
    {
        ...
        $gitExecutorContent = view('actions.git.git-executor', [
            ...
            'systemUsername' => $findHostingSubscription->system_username,
            'selfFile' => $gitExecutorShellFile,
            'afterCommand' => 'che-php /usr/local/che/web/artisan git-repository:mark-as-cloned ' . $this->id,
        ])->render();
