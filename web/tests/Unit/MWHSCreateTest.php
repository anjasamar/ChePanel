...
class MWHSCreateTest extends ActionTestCase
{
    function testCreateInstallation()
    {
        ...
        Artisan::call('che:install-module Microweber');
        ...
        $callCustomerStoreResponse = $this->callApiAuthorizedRouteAction('api.customers.store', [
            'name' => 'Che Unit Test Microweber Customer',
            'email' => 'che-unit-test-microweber-' . rand(1000, 9999) . '@che.com',
        ])->json();
        ...
        $hostingSubscriptionDomain = 'che-unit-test-microweber-' . rand(1000, 9999) . '.com';
