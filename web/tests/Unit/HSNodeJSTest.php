...
class HSNodeJSTest extends ActionTestCase
{
    ...
    function testCreate()
    {
        ...
        $callCustomerStoreResponse = $this->callApiAuthorizedRouteAction(
            'api.customers.store',
            [
                'name' => 'Che Unit Test #' . $randId,
                'email' => 'unit-test-' . $randId . '@che.com',
            ]
        )->json();
        ...
        $createHostingPlan->name = 'Che Unit Test #' . $randId;
        ...
        $hostingSubscriptionDomain = 'che-unit-test-' . $randId . '.com';
        ...
        //
        //        $this->assertTrue(Str::contains($indexPageContent,'Che Panel - PHP App'));
